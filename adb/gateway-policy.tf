...
locals {
  ...
  pihole_domain_list_file = "${path.module}/pihole_domain_list.txt"
#!!!!!!!!!!!!!!!!!!!! remeber to use raw file https://raw.githubusercontent.com/smothersell/repo/main/pihole_domain_list.txt
